...
from builder import build_es_query, build_es_query_v2
import re
import json
import logging
...
def create_condition(field: str, operator: str, value, is_nested: bool = False):
    ...
    return {
        "field": field,  # Keep full path like "addresses.pincode"
        "operator": operator,
        "value": value
    }
...
def build_query_v6(
    ...
    def _is_inner(field_root: str) -> bool:
        return field_root in inner_field_list_norm
